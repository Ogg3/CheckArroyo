...
def iPhone_mode(args, IO_paths, GUI_check, store_data, start_time):
    ...
    for conv_id in convons:
        ...
        for i in curs:
            ...
            # Check time flag
            if res:
                if Carroyo and not partCheck and not content_check:
                ...
                # If the checks did not pass
                    ...
                    if ctype == 1:
                        ...
                        attachments = get_attachment(args, files, contextmanager, proto_string,
                                                              IO_paths.report_time)
                ...
                elif Carroyo and partCheck and content_check:
